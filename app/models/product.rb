class Product < ActiveRecord::Base
  ...
  DOSAGE_FORMS = %w[Ampoule Capsule Cream Drops Gel Gelly Granules Injection Inhaler Liquid Lotion Ointment Powder Sachet Soap Suspension Spray Suppositories Syrup Tablet]
